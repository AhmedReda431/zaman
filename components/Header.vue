  ...
  <div class="header-holder">
    <div class="bg-white">
      <header class="bg-white relative">
        <nav
          class="mx-auto flex max-w-8xl items-center justify-between p-4 px-28 nav-holder"
          aria-label="Global"
        >
          ...
          <div class="flex items-center gap-x-4">
            ...
            >
              <NuxtLink
                :to="{ path: '/' }"
                :class="{
                  'border-b-2 border-b-zaman text-zaman-900': route.path == '/',
                }"
              ...
              <NuxtLink
                ...
                :class="{
                  'border-b-2 border-b-zaman text-zaman-900':
                    route.path.includes('/real-states'),
                }"
            ...
            <div class="flex items-center justify-center">
              <Menu as="div" class="relative ml-3" v-if="isAuthenticated">
                <MenuButton
                  class="relative flex items-center rounded-ful text-sm"
                >
