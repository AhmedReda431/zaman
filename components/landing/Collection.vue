  ...
  <div class="py-8">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div v-else class="mt-6 space-y-8">
        <div
          v-for="(chunk, chunkIndex) in regionChunks"
          :key="chunkIndex"
          :class="{ 'five-item-chunk': chunk.length === 5 }"
        ...
        >
          <div
            ...
            "
            v-for="(region, index) in chunk"
            :key="index"
            class="cursor-pointer img-grid group relative w-full"
          >
            <div
            ...
            <span
              class="absolute text-x-lg bottom-8 left-5 font-semibold text-white"
            >
