        ...
        <div class="mt-10 sm-mt-0">
          <div class="px-4 sm:p-6 col-span-2">
            <RadioGroup v-model="type" class="mt-2 w-max">
              ...
              <div
                class="mt-4 grid grid-cols-4 gap-x-4 gap-y-4 text-center sort-types-holder"
              >
                <RadioGroupOption
                  as="template"
                ...
                >
                  <div
                    :class="[
                      active ? '' : '',
                      checked
                        ? 'bg-zaman-500 border-2 border-zaman-500 bg-opacity-75 text-white checked-type'
                        : 'bg-transparent border-2 border-gray-300 text-gray-300',
            ...
            <ClientOnly>
              <div class="mt-5 grid grid-cols-12 gap-3 bg-white rounded-lg p-3 flex-sm-column">
                <Listbox v-model="type" class="col-span-5">
                  <div class="relative w-full">
                    ...
                    >
                      ...
                      <span
                        class="pointer-events-none absolute inset-y-0 flex items-center rtl:pl-2 pr-2"
                        :class="{
                          'left-0': $i18n.locale == 'ar',
                          'right-0': $i18n.locale == 'en',
                        }"
                      >
                        <ChevronDownIcon
                ...
                <button
                  @click="searchButton"
                  class="mt-0 col-span-2 gap-x-2 flex flex-nowrap border-2 border-zaman items-center justify-center rounded-md bg-zaman px-2 min-w-max text-sm font-semibold text-white shadow-sm hover:bg-zaman-500 sm:mt-0"
                >
