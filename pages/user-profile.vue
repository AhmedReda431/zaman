...
<template>
  <section>
      ...
      <Menu as="div" class="relative ml-3 md:hidden block">
        ...
        >
          ...
          >
            <MenuItem>
              <button
                class="block hover:bg-gray-100 w-full rtl:text-right px-4 py-3 rounded-sm"
                style="min-width: max-content"
                :class="{
                  'text-zaman bg-gray-100':
                    toRaw(currentComponent) === ProfileInfo,
                }"
            ...
            <MenuItem>
              <button
                ...
                :class="{
                  'text-zaman bg-gray-100':
                    toRaw(currentComponent) === ProfileReservations,
                }"
                @click="switchParam('reservations')"
              >
                <Icon
                  size="24"
                  name="material-symbols-light:calendar-month-sharp"
                />
            ...
            <MenuItem>
              <button
                ...
                :class="{
                  'text-zaman bg-gray-100':
                    toRaw(currentComponent) === ProfileFavs,
                }"
            ...
            <MenuItem>
              <button
                ...
                :class="{
                  'text-zaman bg-gray-100':
                    toRaw(currentComponent) === ProfileNotifications,
                }"
            ...
            <MenuItem>
              <button
                ...
                :class="{
                  'text-zaman bg-gray-100':
                    toRaw(currentComponent) === ProfileSettings,
                }"
    ...
    <div class="mx-auto grid md:grid-cols-8 max-w-7xl p-6 gap-10 lg:px-8">
      <div
        class="md:block hidden py-6 bg-white shadow-md rounded-lg col-span-2"
      >
        <button
          class="block hover:bg-gray-100 w-full rtl:text-right px-4 py-3 rounded-sm"
          style="min-width: max-content"
          :class="{
            'text-zaman bg-gray-100': toRaw(currentComponent) === ProfileInfo,
          }"
          @click="switchParam('info')"
        >
        ...
        <button
          ...
          style="min-width: max-content"
          :class="{
            'text-zaman bg-gray-100': toRaw(currentComponent) === ProfileFavs,
          }"
          @click="switchParam('favs')"
        >
          <Icon size="24" name="material-symbols:favorite-outline" />
      ...
      <div class="col-span-6">
        <transition name="fade" mode="out-in">
          <component
            class="flex flex-col items-center md:block bg-white shadow-md h-full rounded-lg p-6"
            :is="currentComponent"
