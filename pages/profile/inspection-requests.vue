<template>
  <div class="component-holder">
    <div
      ...
      v-if="requests?.real_estate_bookings.length && !loading"
    >
          ...
          <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
            ...
            >
              <table class="min-w-full leading-normal">
                ...
                <tbody>
                  <tr
                    v-for="(request, index) in requests.real_estate_bookings"
                    :key="index"
                  >
                    <td
                    ...
                    <td
                      class="px-5 py-5 border-b border-gray-200 bg-white text-sm"
                    >
                      <span v-if="request?.realEstate?.name">
                    ...
                    <td
                      class="px-5 py-5 border-b border-gray-200 bg-white text-sm"
                    >
                      <span v-if="request?.realEstate?.price">
    ...
    <div
      ...
      v-else-if="!requests?.real_estate_bookings.length && !loading"
    >
...
function deleteRequest() {
  $api
    .delete(`/booking-real-estates/${selectedRequest.value.id}`)
    .then((res) => {
