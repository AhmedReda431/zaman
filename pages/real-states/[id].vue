...
onMounted(async () => {
  ...
  if (realState.value.depth)
    info.value.push({
      label: "العمق",
      value: `${realState.value.depth} `,
      icon: "mdi mdi-vector-square",
    });

  info.value.push({
    label: "الكهرباء",
    value: realState.value.electricity ? "نعم" : "لا",
    icon: "mdi mdi-vector-square",
  });
  info.value.push({
    label: "المياه",
    value: realState.value.water ? "نعم" : "لا",
    icon: "mdi mdi-vector-square",
  });
});
...
<template>
  <div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 m-4">
      <div class="md:col-span-2">
            ...
            <RadioGroup v-model="currentTab">
              <div class="mt-4 grid grid-cols-4 gap-y-6 sm:gap-x-4">
                ...
                >
                  <div
                    :class="[
                      active ? 'border-zaman text-white' : 'border-gray-300',
                  ...
                  >
                    ...
                    <span
                      :class="[
                        checked ? 'bg-zaman text-white' : 'border-transparent',
        ...
        <div
          ...
          class="flex space-x-2 rtl:space-x-reverse overflow-x-auto pb-2"
        >
          <div
      ...
      <div
        class="w-full mx-auto bg-white rounded-lg shadow-lg overflow-hidden md:col-span-1"
      >
        <!-- Price -->
        ...
        <!-- Contact buttons -->
        <div
          class="grid grid-cols-1 p-4 gap-2 border-t border-b border-gray-200"
        >
          <button
          ...
          <div v-else>لا يوجد معلومات للتواصل لهذا العقار</div>
    ...
    <div
      class="p-4 md:p-8 bg-white rounded-lg shadow-lg border border-gray-300"
    >
      <h2
        class="text-lg md:text-xl font-semibold text-gray-700 mb-4 text-right"
      >
        معلومات العقار
      </h2>
      <div
        class="grid grid-cols-2 md:grid-cols-5 gap-6 border-t border-gray-200 pt-4"
      >
        <div
    ...
    >
      <h2
        class="text-lg md:text-xl font-semibold text-gray-700 mb-4 text-center"
      >
        معلومات إضافية
      </h2>
      <div
